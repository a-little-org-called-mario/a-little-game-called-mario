...
onready var labels = [
	...
	[
		get_node("MainMenu/GFXLabel"),
		get_node("MainMenu/SFXLabel"),
		get_node("MainMenu/TitleLabel"),
	],
	# all gfx menu items, ordered vertically
	[
		get_node("GFXMenu/BackLabel"),
		get_node("GFXMenu/CamLeanLabel"),
		get_node("GFXMenu/ShakeLabel"),
		get_node("GFXMenu/CRTLabel"),
	],
	# all sfx menu items, ordered vertically
	[
		get_node("SFXMenu/BackLabel"),
		get_node("SFXMenu/GameVolLabel"),
		get_node("SFXMenu/MusicVolLabel"),
		get_node("SFXMenu/SFXVolLabel"),
		get_node("SFXMenu/VoiceVolLabel"),
	],
]
